  ...
  const messages = [
    {
      id: 1,
      from: "Rob Kay",
      preview: "Your order for patient Sarah is ready…",
      time: "11:05 AM",
    },
    {
      id: 2,
      ...
      <div className="flex-1 p-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 bg-white rounded-2xl p-8 shadow-sm">
            <h2 className="text-3xl font-medium text-[#000] mb-2">
              Message Body Example
            </h2>
            <p className="text-base font-medium text-[#000] mb-6">
            ...
            <div className="text-base font-medium text-[#000] leading-relaxed">
              ...
              <p className="mb-2">
                Your Prescription Pickup For Sarah is ready.
              </p>
