      ...
      <div className="flex-1 p-8">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <p className="text-xs font-bold text-[#37AF00]">
              +$54 vs last week
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-4 text-sm font-medium text-[#6D6D6D]">
                    Date
                  </th>
                  <th className="text-left py-4 text-sm font-medium text-[#6D6D6D]">
                    Shift
              ...
              <tbody>
                {payments.map((payment, index) => (
                  <tr key={index} className="border-b border-gray-100">
                    <td className="py-4 text-sm font-medium text-[#000]">
                      {payment.date}
                    </td>
                    <td className="py-4 text-sm font-medium text-[#000]">
                      {payment.shift}
                    </td>
                    <td className="py-4 text-sm font-bold text-[#000]">
                      {payment.amount}
                    </td>
                    <td className="py-4">
                      <span
