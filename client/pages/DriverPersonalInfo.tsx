            ...
            {!isEditing && savedData.fullName ? (
              <div>
                ...
                <button
                  ...
                  className="w-1/2 mx-auto block px-8 py-3 bg-[#2D9CDB] text-white rounded-xl font-medium hover:bg-[#1E7FB5] transition-colors"
                >
                  Edit Info
                </button>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 mt-8">
                  <button
                    ...
                    className="flex-1 px-8 py-3 bg-[#00B074] text-white rounded-xl font-medium hover:bg-[#009060] transition-colors"
                  >
                    Save Changes
                  </button>
                  {savedData.fullName && (
                    <button
                      ...
                      className="flex-1 px-8 py-3 border border-[#D9D9D9] text-[#464255] rounded-xl font-medium hover:bg-[#F3F2F7] transition-colors"
                    >
                      Cancel
                    </button>
                  )}
